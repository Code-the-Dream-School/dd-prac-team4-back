...
const creatJWT = ({ payload }) => { // Create a JWT token with the provided payload
...
const attachCookiesToResponse = ({ res,user }) =>{ // Attach a JWT token as a cookie to the response object
