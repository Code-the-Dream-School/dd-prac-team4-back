    ...
    spotifyUrl: {
      ...
      validate: {
        validator: function (v) {
          return /^https:\/\/api\.spotify\.com\/v1\/albums\/[a-zA-Z0-9]+$/.test(
            v
          ); //ensures that the URL starts with https://api.spotify.com/v1/albums/ followed by alphanumeric characters.
        },
